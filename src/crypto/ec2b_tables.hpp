...
namespace crypto::ec2b_tables {
    constexpr std::array<uint8_t, 16> keyXORPadTable{
    ...
    constexpr std::array<uint8_t, 256> G11{
    ...
    constexpr std::array<uint8_t, 256> G13{
    ...
    constexpr std::array<uint8_t, 256> G14{
    ...
    constexpr std::array<uint8_t, 176> roundKeys{
